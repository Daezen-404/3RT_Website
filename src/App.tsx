        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow" data-aos="fade-up" data-aos-delay="100">
              ...
              <p className="text-gray-600">Simple, secure filing for individuals and families with maximum refund accuracy. Includes small business returns and tailored solutions for entrepreneurs.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow" data-aos="fade-up" data-aos-delay="300">
              ...
              <p className="text-gray-600">Affordable, accurate support for uncontested divorce paperwork, business formations, and official notary services in Texas.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow" data-aos="fade-up" data-aos-delay="400">
              ...
              <p className="text-gray-600">Expert tax consultations to help plan for your financial future. Plus proven strategies for DIY credit repair, including guided tools and templates.</p>
            </div>
          </div>
        </div>
      </section>
